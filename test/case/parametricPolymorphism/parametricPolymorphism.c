...
{
  kmkm_prim_string _l0 = u8"Hello world!";
  return *(((kmkm_prim_string (* (*)(kmkm_prim_string *)))parametricPolymorphism_id)(&_l0));
}

kmkm_prim_int parametricPolymorphism_zero(void)
{
  kmkm_prim_int _l0 = 0;
  return ((kmkm_prim_int (* (*)(kmkm_prim_int *))) parametricPolymorphism_id)(&_l0);
}
