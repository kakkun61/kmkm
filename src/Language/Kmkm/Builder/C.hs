...
buildC :: (MonadThrow m, MonadCatch m) => Config -> Module -> m ([Text], CTranslUnit)
buildC config m = second BC3.convert . BC2.convert config . BC1.convert . B4.lambdaLifting . B3.partialApplication . B2.uncurry <$> B1.typeCheck m
