...
deriving instance (Show (Term c l t), Show (Type c), Show (ValueBind c l t)) => Show (Bind c l t)
deriving instance (Read (Term c l t), Read (Type c), Read (ValueBind c l t)) => Read (Bind c l t)
deriving instance (Eq (Term c l t), Eq (Type c), Eq (ValueBind c l t)) => Eq (Bind c l t)
deriving instance (Ord (Term c l t), Ord (Type c), Ord (ValueBind c l t)) => Ord (Bind c l t)
